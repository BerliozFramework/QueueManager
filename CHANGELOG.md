...
- Worker crash when a job handler calls release() or delete() on the job during handling

## [1.3.1] - 2026-02-04

### Fixed

- Missing unit `mins` for rate limits

## [1.3.0] - 2026-01-21

### Added

- Rate limiters for queues and worker
